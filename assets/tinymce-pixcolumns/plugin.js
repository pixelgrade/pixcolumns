...
// Included from: js/tinymce/plugins/table/classes/Plugin.js
	...
	/**
	 * This class contains all core logic for the columns plugin.
	 *
	...
	define("tinymce/tableplugin/Plugin", [
		...
		function Plugin(editor) {
			...
			function postRender() {
				...
				handleDisabledState(this, 'pixcolumns');
			}
			...
			function generateTableRow() {
				...
				html += '<div class="mce-text-center" role="presentation">1 column</div>';
			...
			function selectGrid(tx, ty, control) {
				...
				table.nextSibling.innerHTML = (tx + 1) + ' columns ';
		...
		PluginManager.add('pixcolumns', Plugin);
	});
})(this);